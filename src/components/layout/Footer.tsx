      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 py-12 lg:py-16">
          ...
          <div className="col-span-2 md:col-span-1 space-y-4">
            <Link to="/" className="inline-flex items-center gap-2.5 group">
              <img src="/logo.png" alt="SmartyTips Logo" width="105" height="28" loading="lazy" className="h-7 w-auto object-contain transition-transform duration-200 group-hover:scale-105" />
          ...
          {/* Connect */}
          <div>
            <h3 className="text-[11px] font-semibold uppercase tracking-widest text-muted-foreground mb-4">Connect</h3>
            <ul className="space-y-2.5">
              <li>
                <a 
                  href="mailto:support@smartytips.com"
                  className="text-sm text-foreground/70 hover:text-primary transition-colors"
                >
              ...
              <li>
                <a 
                  href="https://twitter.com/smartytips" 
                  target="_blank" 
              ...
              <li>
                <a 
                  href="https://github.com/smartytips" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1 text-sm text-foreground/70 hover:text-primary transition-colors"
                >
        ...
        <div className="border-t border-border py-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-muted-foreground">
            &copy; {new Date().getFullYear()} SmartyTips. All rights reserved.
          </p>
