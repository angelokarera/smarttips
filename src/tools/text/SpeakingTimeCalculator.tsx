...
const SPEEDS = [
  { label: 'Slow (100 wpm)', wpm: 100 },
  { label: 'Conversational (130 wpm)', wpm: 130 },
  { label: 'Presentation (150 wpm)', wpm: 150 },
  { label: 'Fast (170 wpm)', wpm: 170 },
]

export default function SpeakingTimeCalculator() {
  ...
  return (
    <div className="space-y-6">
      <Textarea
        placeholder="Paste your speech or script to estimate speaking time..."
        value={text}
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div className="rounded-xl border border-primary/30 bg-primary/5 p-4 text-center">
          ...
          <div className="text-[11px] uppercase tracking-wider text-muted-foreground mt-1">Speaking time</div>
        </div>
      </div>
